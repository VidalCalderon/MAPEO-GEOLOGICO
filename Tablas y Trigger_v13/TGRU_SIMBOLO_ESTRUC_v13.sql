...
IF EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[TGRU_SIMBOLOSESTRL__1K]'))
	DROP TRIGGER dbo.[TGRU_SIMBOLOSESTRL__1K]
GO
...
-- =============================================
CREATE TRIGGER [dbo].[TGRU_SIMBOLOSESTRL__1K]
...
IF EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[TGRU_SIMBOLOSESTRL__2K]'))
	DROP TRIGGER dbo.[TGRU_SIMBOLOSESTRL__2K]
GO
...
-- Description:	Controlar registro de mapeo de ESTRUCTURA (Puntos)
-- =============================================
CREATE TRIGGER [dbo].[TGRU_SIMBOLOSESTRL__2K]
...
IF EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[TGRU_SIMBOLOSESTRL__5K]'))
	DROP TRIGGER dbo.[TGRU_SIMBOLOSESTRL__5K]
GO
...
-- Description:	Controlar registro de mapeo de ESTRUCTURA (Puntos)
-- =============================================
CREATE TRIGGER [dbo].[TGRU_SIMBOLOSESTRL__5K]
...
IF EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[TGRU_SIMBOLOSESTRL_10K]'))
	DROP TRIGGER dbo.[TGRU_SIMBOLOSESTRL_10K]
GO
...
-- Description:	Controlar registro de mapeo de ESTRUCTURA (Puntos)
-- =============================================
CREATE TRIGGER [dbo].[TGRU_SIMBOLOSESTRL_10K]
...
IF EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[TGRU_SIMBOLOSESTRL_25K]'))
	DROP TRIGGER dbo.[TGRU_SIMBOLOSESTRL_25K]
GO
...
-- Description:	Controlar registro de mapeo de ESTRUCTURA (Puntos)
-- =============================================
CREATE TRIGGER [dbo].[TGRU_SIMBOLOSESTRL_25K]
...
IF EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[TGRU_SIMBOLOSESTRL_50K]'))
	DROP TRIGGER dbo.[TGRU_SIMBOLOSESTRL_50K]
GO
...
-- Description:	Controlar registro de mapeo de ESTRUCTURA (Puntos)
-- =============================================
CREATE TRIGGER [dbo].[TGRU_SIMBOLOSESTRL_50K]
