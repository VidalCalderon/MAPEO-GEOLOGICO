...
// mapCommonStyles: módulo interno de jimu-ui no disponible en fuente de desarrollo.
// Se provee una implementación local compatible con la firma original:
// (theme: IMThemeVariables, mapRootClassName: string, extraCss?: string) => string
const mapCommonStyles = (_theme: any, _mapRootClassName: string, extraCss?: string): string => extraCss || ''
